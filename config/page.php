<?php
    if(isset($_GET['backup_app'])){
        ...
        $views = 'views/pinjaman/barang_pinjam.php';
    }
    else if(isset($_GET['barang_kembali'])){
        $pinjaman = $barang_kembali = true;
        $views = 'views/pinjaman/barang_kembali.php';
    }
        ...
        $views = 'views/laporan/lap_barang_pinjam.php';
    }
    else if(isset($_GET['lap_barang_kembali'])){
        $laporan = $lap_barang_kembali = true;
        $views = 'views/laporan/lap_barang_kembali.php';
    }
    else{
        $home = true;
