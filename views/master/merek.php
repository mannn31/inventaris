            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tbody>
                        <?php
                        $n = 1;
                        $query = mysqli_query($con, "SELECT * FROM merek ORDER BY idmerek DESC") or die(mysqli_error($con));
...
<!-- Modal Tambah merek -->
<div class="modal fade" id="merekModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <?php
                                $query = mysqli_query($con, "SELECT max(idmerek) as maxId FROM merek");
                                $data = mysqli_fetch_array($query);
                                $id = $data['maxId'];
                                $urutan = (int) substr($id, 3, 3);
                                $urutan++;
                                $huruf = "M";
                                $idmerek = $huruf . sprintf("%03s", $urutan);
                                ?>
                                <label for="idmerek">Id Merek <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="idmerek" name="idmerek" value="<?php echo $idmerek ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                                <label for="nama_merek">Nama Merek <span class="text-danger">*</span></label>
                                <input type="hidden" name="nama_merek" class="form-control">
