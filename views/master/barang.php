                    ...
                    <div class="row">
                        <div class="col-md-2">
                            <div class="form-group">
                                <?php
                                $query = mysqli_query($con, "SELECT max(idbarang) as maxId FROM barang");
                                ...
                                <input type="text" class="form-control" id="idbarang" name="idbarang" value="<?php echo $idbarang ?>" readonly required>
                            </div>
                        </div>
                        <div class="col-md-10">
                            <div class="form-group">
                                <label for="nama_barang">Nama Barang <span class="text-danger">*</span></label>
                                <input type="hidden" name="nama_barang" class="form-control">
