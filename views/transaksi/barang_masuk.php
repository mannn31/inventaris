...
<div class="container-fluid">
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            ...
            <a href="<?= base_url(); ?>process/cetak_barang_masuk.php" target="_blank" class="btn btn-info btn-icon-split btn-sm float-right">
                <span class="icon text-white-50">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td><?= $row['jumlah']; ?></td>
                                <td>
                                    <a href="<?= base_url(); ?>/process/barang_masuk.php?act=<?= encrypt('delete'); ?>&idbarang_masuk=<?= encrypt($row['idbarang_masuk']); ?>" class="btn btn-sm btn-circle btn-danger btn-hapus"><i class="fas fa-trash"></i></a>
                                </td>
                            </tr>
                        <?php endwhile; ?>
                    </tbody>
...
<!-- Modal Tambah barang -->
<div class="modal fade" id="barang_masuk" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-backdrop="static">
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <div class="form-group">
                                <?php
                                $query = mysqli_query($con, "SELECT max(idbarang_masuk) as maxId FROM barang_masuk");
                                $data = mysqli_fetch_array($query);
                                $id = $data['maxId'];
                                $urutan = (int) substr($id, 3, 3);
                                $urutan++;
                                $huruf = "BI";
                                $idbarang_masuk = $huruf . sprintf("%03s", $urutan);
                                ?>
                                <label for="idbarang_masuk">Id Barang Masuk <span class="text-danger">*</span></label>
                                <input type="text" class="form-control" id="idbarang_masuk" name="idbarang_masuk" value="<?php echo $idbarang_masuk ?>" readonly required>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-5">
